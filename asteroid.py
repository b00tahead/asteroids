...
class Asteroid(CircleShape):
  ...
  def split(self):
    ...
    asteroid_1 = Asteroid(self.position.x, self.position.y, smaller_asteroid_radius)
    asteroid_2 = Asteroid(self.position.x, self.position.y, smaller_asteroid_radius)
